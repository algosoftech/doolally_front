...
console.log(eventsData)
  return (
    <>
      <div className="container-fluid mt-4 pt-4 mb-4 pb-4">
        {isloading && <LoadingSpinner />}
        <Header />

        <div className="d_main_panel myEventDetails">
          <h3 className="d_main_title mb-3 text-center">
                ...
                <div className="col-md-12 col-lg-12">
                  <div className=" d_featured_events_box gray_bg_color">
                    ...
                    <div className="box_padding">
                      <h5 className="">{item.eventName}</h5>
                      <h6
                        style={{
                          color: " #a2c760",
                        }}
                      ...
                      <p style={{ wordWrap: "break-word"}}>{item.eventDescription.substring(0, 160)}</p>
                      <ul
                        className=" row gy-2"
                        style={{
                          listStyleType: "none",
                      ...
                      >
                        ...
                        <li className="col" style={{marginLeft:"1%"}}>
                          <img
                            src={
                              process.env.PUBLIC_URL +
...
{" "}
                                ...
                                }} style={{fontSize:"10px"}}><InfoIcon/></span>
                              </p>
                            </div>
                            <div className="col-6">
                              <p>
                    ...
                    {item.isEventCancel
=='2'? <button className="d_feat_event_btn " style={{border:"none", outline:"none", borderRadius:"5px",backgroundColor:"white", margin:"0 auto", color:"red", padding:"2%" }}> Event Cancelled !</button>:
                   
                    <div className="row gy-2 attaind-pg-btn mb-4">
                      <div className="col-6">
                        <button
