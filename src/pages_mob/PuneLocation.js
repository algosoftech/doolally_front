...
<div className=" home-1st-col d-flex justify-content-center poppins  mt-2 ">
    
<Link to='/mumbai-location' style={{marginRight:"7%"}}>
<p> <img src={process.env.PUBLIC_URL + "/images/mumbai.png"} className="h-1st-col" alt="mumbai"/> <br/>Mumbai</p></Link>
<Link to={'/pune-location'}>
...
<h3 className="d_main_title mt-4">Pune customer reviews </h3>  
...
<div >
<h5 className="poppins"> Taproom in Brewery, NIBM</h5>
...
<img src={process.env.PUBLIC_URL + "/images/map.png"} style={{ width:"120px",height:"125px", marginTop:"-20px"}}/>
   ...
   <strong >Taproom in Brewery </strong>
...
<div >
<h5 className="poppins"> Taproom in Koregaon Park </h5>
<img src={process.env.PUBLIC_URL + "/images/icons/star.jpg"} style={{width:"60px",margin:"0px auto", marginTop:"-20px"}}/>
<p style={{fontSize:"14px", color:'grey', width:"200px"}}>All of Belgium’s modern brewing  can be traced to sustenance brewing, either on the family farm or in monasteries. The witbier style, also known as bière blanche in the French</p>
...
<img src={process.env.PUBLIC_URL + "/images/map.png"} style={{ width:"120px",height:"125px", marginTop:"-20px"}}/>
   ...
   <strong >Taproom in  Koregaon Park </strong>
   <p style={{fontSize:"14px", color:'grey'}}>10:00am-12:00pm</p>
</div>
