...
const [alertEndTime,setAlertEndTime]=useState("");
  ...
  // end alert
const [stateFalse,setStateFalse] = useState();
  ...
  const [form, setForm] = useState({
    ...
    infrastructure: selectedCheckboxes2,
...
console.log(form.infrastructure)
  const getData2 = () => {
  ...
  const onUpdateField = (e) => {
    ...
    if(e.target.name == "infrastructure"){
      ...
      if(fieldValue=="none"){
        // setSelectedCheckboxes2("none");

        setStateFalse(false)
      }else{
        setStateFalse( )
      const currSelectedCheckboxes = selectedCheckboxes2;
      const findIdx = currSelectedCheckboxes.indexOf(fieldValue);
      if (findIdx > -1) {
        currSelectedCheckboxes.splice(findIdx, 1);
      } else {
      ...
      setSelectedCheckboxes2(currSelectedCheckboxes);
    }}
...
<span style={{color:"red", fontSize:"15px"}}>
                      ...
                      {/* {showInfastructure ? ( */}
                        <>
                          ...
                          <div
                            className="row g-4 d_event_list"
                      ...
                      <div className="d_free_or_paid">
                        <div className="d_title_box">
                          <h5 className="d_main_titl">Personal Details</h5>
                        </div>
                      </div>
                      <div className="d_create_event_form">
                        <div className="row g-3">
                          ...
                          <div className="col-md-12 text-center">
                            ...
                            <button className="d_comn_btn d-block d-md-inline-block">
