  ...
  const onSubmitRegistrationForm = async (e) => {
    ...
    try {
      ...
      if (result) {
        ...
        console.log(result);
        if (result.statusCode === "success") {
          if (result.response.result.eventCostType == "paid") {
            let orderData = result.response.result.orderData;
            ...
            <div className="row">
              <div className="col-lg-3 mb-4">
                <div className="d_left_panal box_padding gray_bg_color">
                  ...
                  <h3 className="d_main_title pb-2">Hangout at Doolally </h3>
                  <div className="row gy-2 gx-4">
                    {hangout.slice(2, 8).map((item, id) => (
                      <>
                        <div className="col-6">
              ...
              <div className="col-lg-6 mb-4 ">
                ...
                <div className=" box_padding gray_bg_color">
                  <h3 className="d_main_title mb-4">Event Details</h3>
                  <div className="row">
                    {eventsData.slice(0, 1).map((item, index) => (
                      <div
                        ...
                        <div className="d_featured_events_box">
                          ...
                          <div className="d_feat_event_cn">
                            ...
                            <div style={{ padding: "1% 4%" }}>
                              ...
                              <ul className="d_feat_event_list text-center mt-4">
                          ...
                          <div className="d_feat_event_bn d-flex justify-content-between mt-2 mb-2 mb-2">
              ...
              <div className="col-lg-3">
                <div className="d_right_panal box_padding">
                  <div className="d_title_box">
                    <h3 className="d_main_title">Categories</h3>
                  </div>
                ...
                <div className=" d_main_panel_review mt-3">
                  <div className="d_right_panal box_padding">
                    <div className="d_title_box">
                      <h3 className="d_main_title">What's happening today</h3>
                ...
                <div className="d_create_event_form">
                  <div className="row g-3">
                    ...
                    <div className="col-md-12 poppins">
                      ...
                      >
                        <input
                          className={clsx(
                            styles.formField,
                            errorsRegistration.user_quantity.dirty &&
                              errorsRegistration.user_quantity.error &&
                              styles.formFieldError
                          )}
                          type="number"
                          aria-label="Quantity"
                        ...
                        errorsRegistration.user_quantity.error ? (
                          <p className={styles.formFieldErrorMessage}>
                            {errorsRegistration.user_quantity.message}
                          </p>
                        ) : null}
                      </div>
                      <div
                      ...
                      >
                        <span
                          onClick={incrementRegBookingCount}
                          style={{
                            padding: "3px 10px",
                    ...
                    <div className="col-md-12">
                      ...
                      <Button
                        variant="secondary"
                        onClick={handleCloseRegistrationPop}
                      >
                        {isRegistrationrSubmitButtonLoading
                          ? "Loading..."
                          : "Close"}
